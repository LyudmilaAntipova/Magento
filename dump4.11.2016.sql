...
-- Дамп структуры базы данных magento
CREATE DATABASE IF NOT EXISTS `magento` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `magento`;


-- Дамп структуры для таблица magento.adminnotification_inbox
...
-- Дамп данных таблицы magento.adminnotification_inbox: ~100 rows (приблизительно)
...
INSERT INTO `adminnotification_inbox` (`notification_id`, `severity`, `date_added`, `title`, `description`, `url`, `is_read`, `is_remove`) VALUES
	...
	(4, 4, '2008-11-08 04:46:42', 'Reminder: Change Magento`s default phone numbers and callouts before site launch', 'Before launching your Magento store, please remember to change Magento`s default phone numbers that appear in email templates, callouts, templates, etc.', '', 0, 0),
	...
	(8, 2, '2008-12-31 02:59:22', 'Magento version 1.2.0.1 now available', 'Magento version 1.2.0.1 now available.This version includes some issue resolutions for Magento 1.2.x that are listed in the release notes section.', 'http://www.magentocommerce.com/blog/comments/magento-version-1201-available/', 0, 0),
	...
	(12, 3, '2009-02-24 05:45:47', 'Magento version 1.2.1.1 now available', 'Magento version 1.2.1.1 now available.This version includes some issue resolutions for Magento 1.2.x that are listed in the release notes section.', 'http://www.magentocommerce.com/blog/comments/magento-version-1211-now-available/', 0, 0),
	...
	(28, 4, '2010-02-13 08:39:53', 'Magento CE Version 1.4.0.0 Stable is now available', 'We are excited to announce the availability of Magento CE Version 1.4.0.0 Stable for upgrade and download.', 'http://bit.ly/c53rpK', 0, 0),
	(29, 3, '2010-02-20 07:39:36', 'Magento CE Version 1.4.0.1 Stable is now available', 'Magento CE 1.4.0.1 Stable is now available for upgrade and download.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1401-stable-now-available/', 0, 0),
	...
	(33, 4, '2010-07-27 01:37:34', 'Magento CE Version 1.4.1.1 Stable is now available', 'We are excited to announce the availability of Magento CE Version 1.4.1.1 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1411-stable-now-available/', 0, 0),
	(34, 4, '2010-07-28 09:12:12', 'Magento CE Version 1.4.2.0-beta1 Preview Release Now Available', 'This release gives a preview of the new Magento Connect Manager.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1420-beta1-now-available/', 0, 0),
	...
	(36, 4, '2010-10-12 04:13:25', 'Magento Mobile is now live!', 'Magento Mobile is now live! Signup today to have your own native iPhone mobile-shopping app in iTunes for the holiday season! Learn more at http://www.magentomobile.com/', 'http://www.magentomobile.com/', 0, 0),
	(37, 4, '2010-11-09 02:52:06', 'Magento CE Version 1.4.2.0-RC1 Preview Release Now Available', 'We are happy to announce the availability of Magento Preview Version 1.4.2.0-RC1 for download.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1420-rc1-now-available/', 0, 0),
	(38, 4, '2010-12-03 01:33:00', 'Magento CE Version 1.4.2.0-RC2 Preview Release Now Available', 'We are happy to announce the availability of Magento Preview Version 1.4.2.0-RC2 for download.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-1420-rc2-now-available/', 0, 0),
	(39, 4, '2010-12-09 03:29:55', 'Magento CE Version 1.4.2.0 Stable is now available', 'We are excited to announce the availability of Magento CE Version 1.4.2.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1420-stable-now-available/', 0, 0),
	...
	(47, 4, '2011-02-10 04:42:57', 'Magento CE 1.5.0.1 stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.5.0.1 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-1501-stable-now-available/', 0, 0),
	(48, 4, '2011-03-19 00:15:45', 'Magento CE 1.5.1.0-beta1 Now Available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.1.0-beta1 for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1510-beta1-now-available/', 0, 0),
	(49, 4, '2011-03-31 22:43:02', 'Magento CE 1.5.1.0-rc1 Now Available', 'We are happy to announce the availability of Magento Preview Version CE 1.5.1.0-rc1 for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-preview-version-ce-1510-rc1-now-available/', 0, 0),
	(50, 4, '2011-04-26 23:21:07', 'Magento CE 1.5.1.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.5.1.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1510-stable-now-available/', 0, 0),
	...
	(55, 4, '2011-08-19 21:58:31', 'Magento CE 1.6.0.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.6.0.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1600-stable-now-available/', 0, 0),
	...
	(58, 4, '2011-10-19 21:50:05', 'Magento CE 1.6.1.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.6.1.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1610-stable-now-available/', 0, 0),
	...
	(60, 4, '2012-01-11 22:24:20', 'Magento CE 1.6.2.0-stable Now Available', 'We are excited to announce the availability of Magento CE Version 1.6.2.0 Stable for download and upgrade.', 'http://www.magentocommerce.com/blog/comments/magento-ce-version-1620-stable-now-available/', 0, 0),
	...
	(63, 4, '2012-05-11 09:46:54', 'Magento Community 1.7 and Magento Enterprise 1.12 now available!', 'Learn more about the exciting new features and updates in these releases.', 'http://www.magentocommerce.com/blog/comments/magento-enterprise-112-and-community-17-now-available/', 0, 0),
	...
	(71, 4, '2013-12-11 15:35:06', 'Magento Community Edition 1.8.1.0 is here!', 'This new version offers significant tax calculation, product quality, and security enhancements. Be sure to carefully review the upgrade instructions before starting. More information is available at http://www.magentocommerce.com/blog/comments/magento-community-edition-1810-is-here/', 'http://www.magentocommerce.com/blog/comments/magento-community-edition-1810-is-here/', 0, 0),
	...
	(79, 4, '2014-11-24 23:25:21', 'Magento Community Edition 1.9.1 is available!', 'Magento Community Edition 1.9.1 empowers merchants to deliver compelling shopping experiences by offering enhanced responsive design capabilities, new swatches to display product variations, and improved performance through support for MySQL 5.6 and PHP 5.5. It also includes support for Google Universal Analytics and over 70 product improvements. Find out more at http://magento.com/blog/magento-news/magento-community-edition-191-now-available-download', 'http://magento.com/blog/magento-news/magento-community-edition-191-now-available-download', 0, 0),
	...
	(89, 4, '2015-10-01 17:32:53', 'Episode VI: Return of Imagine Commerce | 2016 Registration is Open!', 'The force is strong with this one. Join the Magento rebellion at Imagine Commerce 2016. Enlist Now at http://imagine.magento.com.', 'http://imagine.magento.com', 0, 0),
	...
	(94, 4, '2016-01-13 22:51:52', 'Have questions? Magento has big answers at Imagine Commerce.', 'Big news, bigger experts, and an even bigger ecosystem. Will you be at Imagine Commerce? Join us. ', 'http://imagine.magento.com', 0, 0),
...
-- Дамп структуры для таблица magento.admin_assert
...
-- Дамп данных таблицы magento.admin_assert: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `admin_assert` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_assert` ENABLE KEYS */;


-- Дамп структуры для таблица magento.admin_role
...
-- Дамп данных таблицы magento.admin_role: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.admin_rule
...
-- Дамп данных таблицы magento.admin_rule: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.admin_user
...
-- Дамп данных таблицы magento.admin_user: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `admin_user` DISABLE KEYS */;
INSERT INTO `admin_user` (`user_id`, `firstname`, `lastname`, `email`, `username`, `password`, `created`, `modified`, `logdate`, `lognum`, `reload_acl_flag`, `is_active`, `extra`, `rp_token`, `rp_token_created_at`) VALUES
	(1, 'Melina', 'Antipova', 'melina.antipova@gmail.com', 'Melina', '9ee850c0989227118ceae5a7b95767a3:QZqLTwRHeb6H6Tu7Mb9dN41BWxwBSWhc', '2016-10-26 17:51:04', '2016-10-26 17:51:04', '2016-11-03 20:17:27', 12, 0, 1, 'b:0;', NULL, NULL);
/*!40000 ALTER TABLE `admin_user` ENABLE KEYS */;


-- Дамп структуры для таблица magento.ain_contact
CREATE TABLE IF NOT EXISTS `ain_contact` (
...
-- Дамп данных таблицы magento.ain_contact: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `ain_contact` DISABLE KEYS */;
INSERT INTO `ain_contact` (`request_id`, `name`, `comment`) VALUES
	(1, 'Anna', 'Best day ever'),
	(2, 'Vera', 'We grow when we face challenges'),
	(3, 'Melina', 'It\'s going to be all right');
/*!40000 ALTER TABLE `ain_contact` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api2_acl_attribute
...
-- Дамп данных таблицы magento.api2_acl_attribute: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `api2_acl_attribute` DISABLE KEYS */;
/*!40000 ALTER TABLE `api2_acl_attribute` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api2_acl_role
...
-- Дамп данных таблицы magento.api2_acl_role: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `api2_acl_role` DISABLE KEYS */;
INSERT INTO `api2_acl_role` (`entity_id`, `created_at`, `updated_at`, `role_name`) VALUES
	(1, '2016-10-26 20:46:09', NULL, 'Guest'),
	(2, '2016-10-26 20:46:09', NULL, 'Customer');
/*!40000 ALTER TABLE `api2_acl_role` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api2_acl_rule
...
-- Дамп данных таблицы magento.api2_acl_rule: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `api2_acl_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `api2_acl_rule` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api2_acl_user
...
-- Дамп данных таблицы magento.api2_acl_user: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `api2_acl_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `api2_acl_user` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api_assert
...
-- Дамп данных таблицы magento.api_assert: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `api_assert` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_assert` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api_role
...
-- Дамп данных таблицы magento.api_role: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `api_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_role` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api_rule
...
-- Дамп данных таблицы magento.api_rule: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `api_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_rule` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api_session
...
-- Дамп данных таблицы magento.api_session: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `api_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_session` ENABLE KEYS */;


-- Дамп структуры для таблица magento.api_user
...
-- Дамп данных таблицы magento.api_user: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `api_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_user` ENABLE KEYS */;


-- Дамп структуры для таблица magento.captcha_log
...
-- Дамп данных таблицы magento.captcha_log: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `captcha_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `captcha_log` ENABLE KEYS */;


-- Дамп структуры для таблица magento.cataloginventory_stock
...
-- Дамп данных таблицы magento.cataloginventory_stock: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.cataloginventory_stock_item
...
-- Дамп данных таблицы magento.cataloginventory_stock_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `cataloginventory_stock_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `cataloginventory_stock_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.cataloginventory_stock_status
...
-- Дамп данных таблицы magento.cataloginventory_stock_status: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `cataloginventory_stock_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `cataloginventory_stock_status` ENABLE KEYS */;


-- Дамп структуры для таблица magento.cataloginventory_stock_status_idx
...
-- Дамп данных таблицы magento.cataloginventory_stock_status_idx: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `cataloginventory_stock_status_idx` DISABLE KEYS */;
/*!40000 ALTER TABLE `cataloginventory_stock_status_idx` ENABLE KEYS */;


-- Дамп структуры для таблица magento.cataloginventory_stock_status_tmp
...
-- Дамп данных таблицы magento.cataloginventory_stock_status_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalogrule
...
-- Дамп данных таблицы magento.catalogrule: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogrule` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogrule` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogrule_affected_product
CREATE TABLE IF NOT EXISTS `catalogrule_affected_product` (
  `product_id` int(10) unsigned NOT NULL COMMENT 'Product Id',
  PRIMARY KEY (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='CatalogRule Affected Product';

-- Дамп данных таблицы magento.catalogrule_affected_product: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogrule_affected_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogrule_affected_product` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogrule_customer_group
...
-- Дамп данных таблицы magento.catalogrule_customer_group: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogrule_customer_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogrule_customer_group` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogrule_group_website
...
-- Дамп данных таблицы magento.catalogrule_group_website: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogrule_group_website` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogrule_group_website` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogrule_product
...
-- Дамп данных таблицы magento.catalogrule_product: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogrule_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogrule_product` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogrule_product_price
...
-- Дамп данных таблицы magento.catalogrule_product_price: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogrule_product_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogrule_product_price` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogrule_website
...
-- Дамп данных таблицы magento.catalogrule_website: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogrule_website` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogrule_website` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogsearch_fulltext
...
-- Дамп данных таблицы magento.catalogsearch_fulltext: 0 rows
/*!40000 ALTER TABLE `catalogsearch_fulltext` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogsearch_fulltext` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogsearch_query
...
-- Дамп данных таблицы magento.catalogsearch_query: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogsearch_query` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogsearch_query` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalogsearch_result
...
-- Дамп данных таблицы magento.catalogsearch_result: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalogsearch_result` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogsearch_result` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_category_anc_categs_index_idx
...
-- Дамп данных таблицы magento.catalog_category_anc_categs_index_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_category_anc_categs_index_tmp
...
-- Дамп данных таблицы magento.catalog_category_anc_categs_index_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_category_anc_products_index_idx
...
-- Дамп данных таблицы magento.catalog_category_anc_products_index_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_category_anc_products_index_tmp
...
-- Дамп данных таблицы magento.catalog_category_anc_products_index_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_category_entity
...
-- Дамп данных таблицы magento.catalog_category_entity: ~2 rows (приблизительно)
...
INSERT INTO `catalog_category_entity` (`entity_id`, `entity_type_id`, `attribute_set_id`, `parent_id`, `created_at`, `updated_at`, `path`, `position`, `level`, `children_count`) VALUES
	(1, 3, 0, 0, '2016-10-26 17:48:24', '2016-10-26 17:48:24', '1', 0, 0, 1),
	(2, 3, 3, 1, '2016-10-26 17:48:26', '2016-10-26 17:48:26', '1/2', 1, 1, 0);
/*!40000 ALTER TABLE `catalog_category_entity` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_category_entity_datetime
...
-- Дамп данных таблицы magento.catalog_category_entity_datetime: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_category_entity_datetime` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_entity_datetime` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_category_entity_decimal
...
-- Дамп данных таблицы magento.catalog_category_entity_decimal: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_category_entity_decimal` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_entity_decimal` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_category_entity_int
...
-- Дамп данных таблицы magento.catalog_category_entity_int: ~6 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_category_entity_text
...
-- Дамп данных таблицы magento.catalog_category_entity_text: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_category_entity_varchar
...
-- Дамп данных таблицы magento.catalog_category_entity_varchar: ~7 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_category_product
...
-- Дамп данных таблицы magento.catalog_category_product: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_category_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_product` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_category_product_index
...
-- Дамп данных таблицы magento.catalog_category_product_index: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_category_product_index` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_product_index` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_category_product_index_enbl_idx
...
-- Дамп данных таблицы magento.catalog_category_product_index_enbl_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_category_product_index_enbl_tmp
...
-- Дамп данных таблицы magento.catalog_category_product_index_enbl_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_category_product_index_idx
...
-- Дамп данных таблицы magento.catalog_category_product_index_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_category_product_index_tmp
...
-- Дамп данных таблицы magento.catalog_category_product_index_tmp: 0 rows
/*!40000 ALTER TABLE `catalog_category_product_index_tmp` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_category_product_index_tmp` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_compare_item
...
-- Дамп данных таблицы magento.catalog_compare_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_compare_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_compare_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_eav_attribute
...
-- Дамп данных таблицы magento.catalog_eav_attribute: ~91 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_bundle_option
...
-- Дамп данных таблицы magento.catalog_product_bundle_option: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_bundle_option` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_bundle_option` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_bundle_option_value
...
-- Дамп данных таблицы magento.catalog_product_bundle_option_value: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_bundle_option_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_bundle_option_value` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_bundle_price_index
...
-- Дамп данных таблицы magento.catalog_product_bundle_price_index: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_bundle_price_index` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_bundle_price_index` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_bundle_selection
...
-- Дамп данных таблицы magento.catalog_product_bundle_selection: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_bundle_selection` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_bundle_selection` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_bundle_selection_price
...
-- Дамп данных таблицы magento.catalog_product_bundle_selection_price: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_bundle_stock_index
...
-- Дамп данных таблицы magento.catalog_product_bundle_stock_index: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_bundle_stock_index` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_bundle_stock_index` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_enabled_index
...
-- Дамп данных таблицы magento.catalog_product_enabled_index: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_enabled_index` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_enabled_index` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity
...
-- Дамп данных таблицы magento.catalog_product_entity: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_datetime
...
-- Дамп данных таблицы magento.catalog_product_entity_datetime: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_datetime` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_datetime` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_decimal
...
-- Дамп данных таблицы magento.catalog_product_entity_decimal: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_decimal` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_decimal` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_gallery
...
-- Дамп данных таблицы magento.catalog_product_entity_gallery: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_gallery` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_gallery` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_group_price
...
-- Дамп данных таблицы magento.catalog_product_entity_group_price: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_entity_int
...
-- Дамп данных таблицы magento.catalog_product_entity_int: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_int` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_int` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_media_gallery
...
-- Дамп данных таблицы magento.catalog_product_entity_media_gallery: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_media_gallery` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_media_gallery` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_media_gallery_value
...
-- Дамп данных таблицы magento.catalog_product_entity_media_gallery_value: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_media_gallery_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_media_gallery_value` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_text
...
-- Дамп данных таблицы magento.catalog_product_entity_text: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_text` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_tier_price
...
-- Дамп данных таблицы magento.catalog_product_entity_tier_price: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_tier_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_tier_price` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_entity_varchar
...
-- Дамп данных таблицы magento.catalog_product_entity_varchar: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_entity_varchar` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_entity_varchar` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_index_eav
...
-- Дамп данных таблицы magento.catalog_product_index_eav: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_index_eav` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_index_eav` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_index_eav_decimal
...
-- Дамп данных таблицы magento.catalog_product_index_eav_decimal: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_eav_decimal_idx
...
-- Дамп данных таблицы magento.catalog_product_index_eav_decimal_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_eav_decimal_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_eav_decimal_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_eav_idx
...
-- Дамп данных таблицы magento.catalog_product_index_eav_idx: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_index_eav_idx` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_index_eav_idx` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_index_eav_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_eav_tmp: 0 rows
/*!40000 ALTER TABLE `catalog_product_index_eav_tmp` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_index_eav_tmp` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_index_group_price
...
-- Дамп данных таблицы magento.catalog_product_index_group_price: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price
...
-- Дамп данных таблицы magento.catalog_product_index_price: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_index_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_index_price` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_index_price_bundle_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_bundle_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_bundle_opt_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_bundle_opt_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_bundle_opt_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_bundle_opt_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_bundle_sel_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_bundle_sel_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_bundle_sel_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_bundle_sel_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_bundle_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_bundle_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_cfg_opt_agr_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_cfg_opt_agr_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_cfg_opt_agr_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_cfg_opt_agr_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_cfg_opt_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_cfg_opt_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_cfg_opt_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_cfg_opt_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_downlod_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_downlod_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_downlod_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_downlod_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_final_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_final_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_final_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_final_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_idx: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_index_price_idx` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_index_price_idx` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_index_price_opt_agr_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_opt_agr_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_opt_agr_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_opt_agr_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_opt_idx
...
-- Дамп данных таблицы magento.catalog_product_index_price_opt_idx: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_index_price_opt_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_opt_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_price_tmp
...
-- Дамп данных таблицы magento.catalog_product_index_price_tmp: 0 rows
...
-- Дамп структуры для таблица magento.catalog_product_index_tier_price
...
-- Дамп данных таблицы magento.catalog_product_index_tier_price: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_index_tier_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_index_tier_price` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_index_website
...
-- Дамп данных таблицы magento.catalog_product_index_website: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_index_website` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_index_website` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_link
...
-- Дамп данных таблицы magento.catalog_product_link: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_link` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_link_attribute
...
-- Дамп данных таблицы magento.catalog_product_link_attribute: ~5 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_link_attribute_decimal
...
-- Дамп данных таблицы magento.catalog_product_link_attribute_decimal: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_link_attribute_decimal` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_link_attribute_decimal` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_link_attribute_int
...
-- Дамп данных таблицы magento.catalog_product_link_attribute_int: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_link_attribute_int` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_link_attribute_int` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_link_attribute_varchar
...
-- Дамп данных таблицы magento.catalog_product_link_attribute_varchar: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_link_attribute_varchar` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_link_attribute_varchar` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_link_type
...
-- Дамп данных таблицы magento.catalog_product_link_type: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_option
...
-- Дамп данных таблицы magento.catalog_product_option: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_option` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_option` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_option_price
...
-- Дамп данных таблицы magento.catalog_product_option_price: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_option_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_option_price` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_option_title
...
-- Дамп данных таблицы magento.catalog_product_option_title: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_option_title` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_option_title` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_option_type_price
...
-- Дамп данных таблицы magento.catalog_product_option_type_price: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_option_type_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_option_type_price` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_option_type_title
...
-- Дамп данных таблицы magento.catalog_product_option_type_title: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_option_type_title` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_option_type_title` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_option_type_value
...
-- Дамп данных таблицы magento.catalog_product_option_type_value: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_option_type_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_option_type_value` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_relation
...
-- Дамп данных таблицы magento.catalog_product_relation: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_relation` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_super_attribute
...
-- Дамп данных таблицы magento.catalog_product_super_attribute: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_super_attribute` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_super_attribute` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_super_attribute_label
...
-- Дамп данных таблицы magento.catalog_product_super_attribute_label: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_super_attribute_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_super_attribute_label` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_super_attribute_pricing
...
-- Дамп данных таблицы magento.catalog_product_super_attribute_pricing: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.catalog_product_super_link
...
-- Дамп данных таблицы magento.catalog_product_super_link: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_super_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_super_link` ENABLE KEYS */;


-- Дамп структуры для таблица magento.catalog_product_website
...
-- Дамп данных таблицы magento.catalog_product_website: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_product_website` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_product_website` ENABLE KEYS */;


-- Дамп структуры для таблица magento.checkout_agreement
...
-- Дамп данных таблицы magento.checkout_agreement: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `checkout_agreement` DISABLE KEYS */;
/*!40000 ALTER TABLE `checkout_agreement` ENABLE KEYS */;


-- Дамп структуры для таблица magento.checkout_agreement_store
...
-- Дамп данных таблицы magento.checkout_agreement_store: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `checkout_agreement_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `checkout_agreement_store` ENABLE KEYS */;


-- Дамп структуры для таблица magento.cms_block
...
-- Дамп данных таблицы magento.cms_block_store: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица magento.cms_page
...
-- Дамп данных таблицы magento.cms_page: ~6 rows (приблизительно)
...
-- Дамп данных таблицы magento.cms_page_store: ~5 rows (приблизительно)
...
-- Дамп структуры для таблица magento.core_cache
...
-- Дамп данных таблицы magento.core_cache: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_cache` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_cache` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_cache_option
...
-- Дамп данных таблицы magento.core_cache_option: ~8 rows (приблизительно)
...
-- Дамп структуры для таблица magento.core_cache_tag
...
-- Дамп данных таблицы magento.core_cache_tag: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_cache_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_cache_tag` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_config_data
...
-- Дамп данных таблицы magento.core_config_data: ~15 rows (приблизительно)
...
INSERT INTO `core_config_data` (`config_id`, `scope`, `scope_id`, `path`, `value`) VALUES
	...
	(9, 'default', 0, 'web/unsecure/base_url', 'http://magento/'),
	(10, 'default', 0, 'web/secure/base_url', 'http://magento/'),
...
-- Дамп структуры для таблица magento.core_email_queue
...
-- Дамп данных таблицы magento.core_email_queue: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_email_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_email_queue` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_email_queue_recipients
...
-- Дамп данных таблицы magento.core_email_queue_recipients: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_email_queue_recipients` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_email_queue_recipients` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_email_template
...
-- Дамп данных таблицы magento.core_email_template: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_email_template` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_email_template` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_flag
...
-- Дамп данных таблицы magento.core_flag: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_flag` DISABLE KEYS */;
INSERT INTO `core_flag` (`flag_id`, `flag_code`, `state`, `flag_data`, `last_update`) VALUES
	(1, 'admin_notification_survey', 0, 'a:1:{s:13:"survey_viewed";b:1;}', '2016-10-26 17:51:07');
/*!40000 ALTER TABLE `core_flag` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_layout_link
...
-- Дамп данных таблицы magento.core_layout_link: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_layout_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_layout_link` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_layout_update
...
-- Дамп данных таблицы magento.core_layout_update: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_layout_update` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_layout_update` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_resource
...
-- Дамп данных таблицы magento.core_resource: ~49 rows (приблизительно)
...
-- Дамп структуры для таблица magento.core_session
...
-- Дамп данных таблицы magento.core_session: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_session` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_store
...
-- Дамп данных таблицы magento.core_store: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.core_store_group
...
-- Дамп данных таблицы magento.core_store_group: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.core_translate
...
-- Дамп данных таблицы magento.core_translate: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_translate` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_translate` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_url_rewrite
...
-- Дамп данных таблицы magento.core_url_rewrite: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_url_rewrite` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_url_rewrite` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_variable
...
-- Дамп данных таблицы magento.core_variable: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_variable` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_variable` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_variable_value
...
-- Дамп данных таблицы magento.core_variable_value: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `core_variable_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_variable_value` ENABLE KEYS */;


-- Дамп структуры для таблица magento.core_website
...
-- Дамп данных таблицы magento.core_website: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.coupon_aggregated
...
-- Дамп данных таблицы magento.coupon_aggregated: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `coupon_aggregated` DISABLE KEYS */;
/*!40000 ALTER TABLE `coupon_aggregated` ENABLE KEYS */;


-- Дамп структуры для таблица magento.coupon_aggregated_order
...
-- Дамп данных таблицы magento.coupon_aggregated_order: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `coupon_aggregated_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `coupon_aggregated_order` ENABLE KEYS */;


-- Дамп структуры для таблица magento.coupon_aggregated_updated
...
-- Дамп данных таблицы magento.coupon_aggregated_updated: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `coupon_aggregated_updated` DISABLE KEYS */;
/*!40000 ALTER TABLE `coupon_aggregated_updated` ENABLE KEYS */;


-- Дамп структуры для таблица magento.cron_schedule
...
-- Дамп данных таблицы magento.cron_schedule: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `cron_schedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `cron_schedule` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_address_entity
...
-- Дамп данных таблицы magento.customer_address_entity: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_address_entity` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_address_entity` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_address_entity_datetime
...
-- Дамп данных таблицы magento.customer_address_entity_datetime: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.customer_address_entity_decimal
...
-- Дамп данных таблицы magento.customer_address_entity_decimal: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.customer_address_entity_int
...
-- Дамп данных таблицы magento.customer_address_entity_int: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_address_entity_int` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_address_entity_int` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_address_entity_text
...
-- Дамп данных таблицы magento.customer_address_entity_text: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_address_entity_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_address_entity_text` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_address_entity_varchar
...
-- Дамп данных таблицы magento.customer_address_entity_varchar: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_address_entity_varchar` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_address_entity_varchar` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_eav_attribute
...
-- Дамп данных таблицы magento.customer_eav_attribute: ~40 rows (приблизительно)
...
-- Дамп структуры для таблица magento.customer_eav_attribute_website
...
-- Дамп данных таблицы magento.customer_eav_attribute_website: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_eav_attribute_website` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_eav_attribute_website` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_entity
...
-- Дамп данных таблицы magento.customer_entity: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_entity` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_entity` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_entity_datetime
...
-- Дамп данных таблицы magento.customer_entity_datetime: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_entity_datetime` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_entity_datetime` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_entity_decimal
...
-- Дамп данных таблицы magento.customer_entity_decimal: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_entity_decimal` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_entity_decimal` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_entity_int
...
-- Дамп данных таблицы magento.customer_entity_int: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_entity_int` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_entity_int` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_entity_text
...
-- Дамп данных таблицы magento.customer_entity_text: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_entity_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_entity_text` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_entity_varchar
...
-- Дамп данных таблицы magento.customer_entity_varchar: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_entity_varchar` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_entity_varchar` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_flowpassword
...
-- Дамп данных таблицы magento.customer_flowpassword: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `customer_flowpassword` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_flowpassword` ENABLE KEYS */;


-- Дамп структуры для таблица magento.customer_form_attribute
...
-- Дамп данных таблицы magento.customer_form_attribute: ~94 rows (приблизительно)
...
-- Дамп структуры для таблица magento.customer_group
...
-- Дамп данных таблицы magento.customer_group: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица magento.dataflow_batch
...
-- Дамп данных таблицы magento.dataflow_batch: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dataflow_batch` DISABLE KEYS */;
/*!40000 ALTER TABLE `dataflow_batch` ENABLE KEYS */;


-- Дамп структуры для таблица magento.dataflow_batch_export
...
-- Дамп данных таблицы magento.dataflow_batch_export: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dataflow_batch_export` DISABLE KEYS */;
/*!40000 ALTER TABLE `dataflow_batch_export` ENABLE KEYS */;


-- Дамп структуры для таблица magento.dataflow_batch_import
...
-- Дамп данных таблицы magento.dataflow_batch_import: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dataflow_batch_import` DISABLE KEYS */;
/*!40000 ALTER TABLE `dataflow_batch_import` ENABLE KEYS */;


-- Дамп структуры для таблица magento.dataflow_import_data
...
-- Дамп данных таблицы magento.dataflow_import_data: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dataflow_import_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `dataflow_import_data` ENABLE KEYS */;


-- Дамп структуры для таблица magento.dataflow_profile
...
-- Дамп данных таблицы magento.dataflow_profile: ~6 rows (приблизительно)
...
-- Дамп данных таблицы magento.dataflow_profile_history: ~6 rows (приблизительно)
...
INSERT INTO `dataflow_profile_history` (`history_id`, `profile_id`, `action_code`, `user_id`, `performed_at`) VALUES
	(1, 1, 'create', 0, '2016-10-26 17:47:30'),
	(2, 2, 'create', 0, '2016-10-26 17:47:30'),
	(3, 3, 'create', 0, '2016-10-26 17:47:30'),
	(4, 4, 'create', 0, '2016-10-26 17:47:30'),
	(5, 5, 'create', 0, '2016-10-26 17:47:30'),
	(6, 6, 'create', 0, '2016-10-26 17:47:30');
/*!40000 ALTER TABLE `dataflow_profile_history` ENABLE KEYS */;


-- Дамп структуры для таблица magento.dataflow_session
...
-- Дамп данных таблицы magento.dataflow_session: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dataflow_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `dataflow_session` ENABLE KEYS */;


-- Дамп структуры для таблица magento.design_change
...
-- Дамп данных таблицы magento.design_change: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `design_change` DISABLE KEYS */;
/*!40000 ALTER TABLE `design_change` ENABLE KEYS */;


-- Дамп структуры для таблица magento.directory_country
...
-- Дамп данных таблицы magento.directory_country: ~246 rows (приблизительно)
...
-- Дамп структуры для таблица magento.directory_country_format
...
-- Дамп данных таблицы magento.directory_country_format: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `directory_country_format` DISABLE KEYS */;
/*!40000 ALTER TABLE `directory_country_format` ENABLE KEYS */;


-- Дамп структуры для таблица magento.directory_country_region
...
-- Дамп данных таблицы magento.directory_country_region: ~443 rows (приблизительно)
...
-- Дамп структуры для таблица magento.directory_country_region_name
...
-- Дамп данных таблицы magento.directory_country_region_name: ~484 rows (приблизительно)
...
-- Дамп структуры для таблица magento.directory_currency_rate
...
-- Дамп данных таблицы magento.directory_currency_rate: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица magento.downloadable_link
...
-- Дамп данных таблицы magento.downloadable_link: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `downloadable_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `downloadable_link` ENABLE KEYS */;


-- Дамп структуры для таблица magento.downloadable_link_price
...
-- Дамп данных таблицы magento.downloadable_link_price: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `downloadable_link_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `downloadable_link_price` ENABLE KEYS */;


-- Дамп структуры для таблица magento.downloadable_link_purchased
...
-- Дамп данных таблицы magento.downloadable_link_purchased: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `downloadable_link_purchased` DISABLE KEYS */;
/*!40000 ALTER TABLE `downloadable_link_purchased` ENABLE KEYS */;


-- Дамп структуры для таблица magento.downloadable_link_purchased_item
...
-- Дамп данных таблицы magento.downloadable_link_purchased_item: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.downloadable_link_title
...
-- Дамп данных таблицы magento.downloadable_link_title: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `downloadable_link_title` DISABLE KEYS */;
/*!40000 ALTER TABLE `downloadable_link_title` ENABLE KEYS */;


-- Дамп структуры для таблица magento.downloadable_sample
...
-- Дамп данных таблицы magento.downloadable_sample: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `downloadable_sample` DISABLE KEYS */;
/*!40000 ALTER TABLE `downloadable_sample` ENABLE KEYS */;


-- Дамп структуры для таблица magento.downloadable_sample_title
...
-- Дамп данных таблицы magento.downloadable_sample_title: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `downloadable_sample_title` DISABLE KEYS */;
/*!40000 ALTER TABLE `downloadable_sample_title` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_attribute
...
-- Дамп данных таблицы magento.eav_attribute: ~131 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_attribute_group
...
-- Дамп данных таблицы magento.eav_attribute_group: ~17 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_attribute_label
...
-- Дамп данных таблицы magento.eav_attribute_label: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `eav_attribute_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_attribute_label` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_attribute_option
...
-- Дамп данных таблицы magento.eav_attribute_option: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_attribute_option_value
...
-- Дамп данных таблицы magento.eav_attribute_option_value: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_attribute_set
...
-- Дамп данных таблицы magento.eav_attribute_set: ~8 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_entity
...
-- Дамп данных таблицы magento.eav_entity: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `eav_entity` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_entity` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_entity_attribute
...
-- Дамп данных таблицы magento.eav_entity_attribute: ~129 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_entity_datetime
...
-- Дамп данных таблицы magento.eav_entity_datetime: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `eav_entity_datetime` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_entity_datetime` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_entity_decimal
...
-- Дамп данных таблицы magento.eav_entity_decimal: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `eav_entity_decimal` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_entity_decimal` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_entity_int
...
-- Дамп данных таблицы magento.eav_entity_int: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `eav_entity_int` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_entity_int` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_entity_store
...
-- Дамп данных таблицы magento.eav_entity_store: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `eav_entity_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_entity_store` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_entity_text
...
-- Дамп данных таблицы magento.eav_entity_text: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `eav_entity_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_entity_text` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_entity_type
...
-- Дамп данных таблицы magento.eav_entity_type: ~8 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_entity_varchar
...
-- Дамп данных таблицы magento.eav_entity_varchar: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `eav_entity_varchar` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_entity_varchar` ENABLE KEYS */;


-- Дамп структуры для таблица magento.eav_form_element
...
-- Дамп данных таблицы magento.eav_form_element: ~57 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_form_fieldset
...
-- Дамп данных таблицы magento.eav_form_fieldset: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_form_fieldset_label
...
-- Дамп данных таблицы magento.eav_form_fieldset_label: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_form_type
...
-- Дамп данных таблицы magento.eav_form_type: ~5 rows (приблизительно)
...
-- Дамп структуры для таблица magento.eav_form_type_entity
...
-- Дамп данных таблицы magento.eav_form_type_entity: ~8 rows (приблизительно)
...
-- Дамп структуры для таблица magento.gift_message
...
-- Дамп данных таблицы magento.gift_message: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `gift_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `gift_message` ENABLE KEYS */;


-- Дамп структуры для таблица magento.importexport_importdata
...
-- Дамп данных таблицы magento.importexport_importdata: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `importexport_importdata` DISABLE KEYS */;
/*!40000 ALTER TABLE `importexport_importdata` ENABLE KEYS */;


-- Дамп структуры для таблица magento.index_event
...
-- Дамп данных таблицы magento.index_event: ~2 rows (приблизительно)
...
INSERT INTO `index_event` (`event_id`, `type`, `entity`, `entity_pk`, `created_at`, `old_data`, `new_data`) VALUES
	(1, 'save', 'catalog_category', 1, '2016-10-26 17:48:26', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:0;s:34:"catalog_product_price_match_result";b:0;s:24:"catalog_url_match_result";b:1;s:37:"catalog_category_product_match_result";b:1;s:35:"catalogsearch_fulltext_match_result";b:1;}'),
	(2, 'save', 'catalog_category', 2, '2016-10-26 17:48:27', NULL, 'a:5:{s:35:"cataloginventory_stock_match_result";b:0;s:34:"catalog_product_price_match_result";b:0;s:24:"catalog_url_match_result";b:1;s:37:"catalog_category_product_match_result";b:1;s:35:"catalogsearch_fulltext_match_result";b:1;}');
/*!40000 ALTER TABLE `index_event` ENABLE KEYS */;


-- Дамп структуры для таблица magento.index_process
...
-- Дамп данных таблицы magento.index_process: ~9 rows (приблизительно)
...
INSERT INTO `index_process` (`process_id`, `indexer_code`, `status`, `started_at`, `ended_at`, `mode`) VALUES
	...
	(3, 'catalog_url', 'require_reindex', '2016-10-26 17:48:27', '2016-10-26 17:48:27', 'real_time'),
	(4, 'catalog_product_flat', 'require_reindex', NULL, NULL, 'real_time'),
	(5, 'catalog_category_flat', 'require_reindex', NULL, NULL, 'real_time'),
	(6, 'catalog_category_product', 'require_reindex', '2016-10-26 17:48:27', '2016-10-26 17:48:27', 'real_time'),
	(7, 'catalogsearch_fulltext', 'require_reindex', '2016-10-26 17:48:27', '2016-10-26 17:48:27', 'real_time'),
...
-- Дамп структуры для таблица magento.index_process_event
...
-- Дамп данных таблицы magento.index_process_event: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `index_process_event` DISABLE KEYS */;
/*!40000 ALTER TABLE `index_process_event` ENABLE KEYS */;


-- Дамп структуры для таблица magento.log_customer
...
-- Дамп данных таблицы magento.log_customer: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `log_customer` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_customer` ENABLE KEYS */;


-- Дамп структуры для таблица magento.log_quote
...
-- Дамп данных таблицы magento.log_quote: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `log_quote` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_quote` ENABLE KEYS */;


-- Дамп структуры для таблица magento.log_summary
...
-- Дамп данных таблицы magento.log_summary: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `log_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_summary` ENABLE KEYS */;


-- Дамп структуры для таблица magento.log_summary_type
...
-- Дамп данных таблицы magento.log_summary_type: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.log_url
...
-- Дамп данных таблицы magento.log_url: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `log_url` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_url` ENABLE KEYS */;


-- Дамп структуры для таблица magento.log_url_info
...
-- Дамп данных таблицы magento.log_url_info: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `log_url_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_url_info` ENABLE KEYS */;


-- Дамп структуры для таблица magento.log_visitor
...
-- Дамп данных таблицы magento.log_visitor: ~18 rows (приблизительно)
...
INSERT INTO `log_visitor` (`visitor_id`, `session_id`, `first_visit_at`, `last_visit_at`, `last_url_id`, `store_id`) VALUES
	(1, 'q8kbob113bat4vgkhr75adonv1', '2016-10-26 17:51:58', '2016-10-26 17:58:39', 0, 1),
	(2, 'jaskess70r4jhv1ei09i4s3bu4', '2016-10-27 07:10:28', '2016-10-27 07:10:35', 0, 1),
	(3, '3q7etrpvsojg0ojp7j1a5u3ia1', '2016-10-28 07:14:02', '2016-10-28 09:16:26', 0, 1),
	(4, 'j09v0dt5o213pgrtm2kbs6nks5', '2016-10-28 11:33:33', '2016-10-28 11:47:35', 0, 1),
	(5, 'dpit209tncd24drvsl57qg1d30', '2016-10-28 16:27:00', '2016-10-28 17:01:04', 0, 1),
	(6, 'b6tqhfkfrv03davjfrrq89qrk1', '2016-10-28 18:24:22', '2016-10-28 18:24:24', 0, 1),
	(7, 'pgi9jil9d0ktk0241101ibp1r3', '2016-10-30 09:13:43', '2016-10-30 09:41:37', 0, 1),
	(8, 't2oova8os89usmtus8qhkv2jf7', '2016-10-30 11:01:31', '2016-10-30 11:48:14', 0, 1),
	(9, '0g16j6rhqq8frhniikung51qe0', '2016-10-30 16:11:56', '2016-10-30 16:12:27', 0, 1),
	(10, 'lc8ldbhea6sq857ep7d1ihiks6', '2016-10-31 11:36:22', '2016-10-31 11:36:33', 0, 1),
	(11, 't5mf66f9bqc3nvdr3tuklr1tj4', '2016-11-02 07:51:53', '2016-11-02 07:53:38', 0, 1),
	(12, 'l930op22q51j8q7oef0h161ca1', '2016-11-02 09:18:05', '2016-11-02 10:14:49', 0, 1),
	(13, 'pmof8t65pe0laev568ri9uf584', '2016-11-02 13:21:53', '2016-11-02 13:27:25', 0, 1),
	(14, 'n4uousiv66hb4bsn5e6m2263q2', '2016-11-02 14:48:15', '2016-11-02 14:48:15', 0, 1),
	(15, 'n4uousiv66hb4bsn5e6m2263q2', '2016-11-02 14:55:06', '2016-11-02 14:55:06', 0, 1),
	(16, 'n4uousiv66hb4bsn5e6m2263q2', '2016-11-02 14:56:48', '2016-11-02 14:56:48', 0, 1),
	(17, 'n4uousiv66hb4bsn5e6m2263q2', '2016-11-02 14:56:57', '2016-11-02 14:56:59', 0, 1),
	(18, '9ck6devkaaqdd4160fvagoat05', '2016-11-03 07:24:02', '2016-11-03 09:51:37', 0, 1),
	(19, '29k8houf6gqpvl265fmbuifim3', '2016-11-03 19:48:01', '2016-11-03 20:01:51', 0, 1),
	(20, 'jvguk5mt8t8g20un48fgi2em54', '2016-11-04 07:14:09', '2016-11-04 07:32:00', 0, 1),
	(21, '42ub8qa7v8117ic7jhshr51if5', '2016-11-04 07:14:17', '2016-11-04 07:14:17', 0, 1);
/*!40000 ALTER TABLE `log_visitor` ENABLE KEYS */;


-- Дамп структуры для таблица magento.log_visitor_info
...
-- Дамп данных таблицы magento.log_visitor_info: ~19 rows (приблизительно)
...
INSERT INTO `log_visitor_info` (`visitor_id`, `http_referer`, `http_user_agent`, `http_accept_charset`, `http_accept_language`, `server_addr`, `remote_addr`) VALUES
	(1, 'http://magento/index.php/install/wizard/end/', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(2, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(3, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(4, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(5, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(6, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(7, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(8, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(9, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(10, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(11, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(12, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(13, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(14, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(15, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(16, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(17, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(18, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(19, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(20, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.87 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001),
	(21, NULL, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.87 Safari/537.36', NULL, 'uk-UA,uk;q=0.8,ru;q=0.6,en-US;q=0.4,en;q=0.2', _binary 0x7F000001, _binary 0x7F000001);
/*!40000 ALTER TABLE `log_visitor_info` ENABLE KEYS */;


-- Дамп структуры для таблица magento.log_visitor_online
...
-- Дамп данных таблицы magento.log_visitor_online: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `log_visitor_online` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_visitor_online` ENABLE KEYS */;


-- Дамп структуры для таблица magento.newsletter_problem
...
-- Дамп данных таблицы magento.newsletter_problem: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `newsletter_problem` DISABLE KEYS */;
/*!40000 ALTER TABLE `newsletter_problem` ENABLE KEYS */;


-- Дамп структуры для таблица magento.newsletter_queue
...
-- Дамп данных таблицы magento.newsletter_queue: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `newsletter_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `newsletter_queue` ENABLE KEYS */;


-- Дамп структуры для таблица magento.newsletter_queue_link
...
-- Дамп данных таблицы magento.newsletter_queue_link: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `newsletter_queue_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `newsletter_queue_link` ENABLE KEYS */;


-- Дамп структуры для таблица magento.newsletter_queue_store_link
...
-- Дамп данных таблицы magento.newsletter_queue_store_link: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `newsletter_queue_store_link` DISABLE KEYS */;
/*!40000 ALTER TABLE `newsletter_queue_store_link` ENABLE KEYS */;


-- Дамп структуры для таблица magento.newsletter_subscriber
...
-- Дамп данных таблицы magento.newsletter_subscriber: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `newsletter_subscriber` DISABLE KEYS */;
/*!40000 ALTER TABLE `newsletter_subscriber` ENABLE KEYS */;


-- Дамп структуры для таблица magento.newsletter_template
...
-- Дамп данных таблицы magento.newsletter_template: ~0 rows (приблизительно)
...
-- Дамп данных таблицы magento.oauth_consumer: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `oauth_consumer` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth_consumer` ENABLE KEYS */;


-- Дамп структуры для таблица magento.oauth_nonce
...
-- Дамп данных таблицы magento.oauth_nonce: 0 rows
/*!40000 ALTER TABLE `oauth_nonce` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth_nonce` ENABLE KEYS */;


-- Дамп структуры для таблица magento.oauth_token
...
-- Дамп данных таблицы magento.oauth_token: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `oauth_token` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth_token` ENABLE KEYS */;


-- Дамп структуры для таблица magento.paypal_cert
...
-- Дамп данных таблицы magento.paypal_cert: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `paypal_cert` DISABLE KEYS */;
/*!40000 ALTER TABLE `paypal_cert` ENABLE KEYS */;


-- Дамп структуры для таблица magento.paypal_payment_transaction
...
-- Дамп данных таблицы magento.paypal_payment_transaction: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `paypal_payment_transaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `paypal_payment_transaction` ENABLE KEYS */;


-- Дамп структуры для таблица magento.paypal_settlement_report
...
-- Дамп данных таблицы magento.paypal_settlement_report: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `paypal_settlement_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `paypal_settlement_report` ENABLE KEYS */;


-- Дамп структуры для таблица magento.paypal_settlement_report_row
...
-- Дамп данных таблицы magento.paypal_settlement_report_row: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `paypal_settlement_report_row` DISABLE KEYS */;
/*!40000 ALTER TABLE `paypal_settlement_report_row` ENABLE KEYS */;


-- Дамп структуры для таблица magento.permission_block
...
-- Дамп данных таблицы magento.permission_block: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.permission_variable
...
-- Дамп данных таблицы magento.permission_variable: ~15 rows (приблизительно)
...
-- Дамп структуры для таблица magento.persistent_session
...
-- Дамп данных таблицы magento.persistent_session: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `persistent_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `persistent_session` ENABLE KEYS */;


-- Дамп структуры для таблица magento.poll
...
-- Дамп данных таблицы magento.poll: ~0 rows (приблизительно)
...
INSERT INTO `poll` (`poll_id`, `poll_title`, `votes_count`, `store_id`, `date_posted`, `date_closed`, `active`, `closed`, `answers_display`) VALUES
	(1, 'What is your favorite color', 7, 0, '2016-10-26 17:48:31', NULL, 1, 0, NULL);
/*!40000 ALTER TABLE `poll` ENABLE KEYS */;


-- Дамп структуры для таблица magento.poll_answer
...
-- Дамп данных таблицы magento.poll_answer: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица magento.poll_store
...
-- Дамп данных таблицы magento.poll_store: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.poll_vote
...
-- Дамп данных таблицы magento.poll_vote: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `poll_vote` DISABLE KEYS */;
/*!40000 ALTER TABLE `poll_vote` ENABLE KEYS */;


-- Дамп структуры для таблица magento.product_alert_price
...
-- Дамп данных таблицы magento.product_alert_price: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `product_alert_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_alert_price` ENABLE KEYS */;


-- Дамп структуры для таблица magento.product_alert_stock
...
-- Дамп данных таблицы magento.product_alert_stock: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `product_alert_stock` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_alert_stock` ENABLE KEYS */;


-- Дамп структуры для таблица magento.rating
...
-- Дамп данных таблицы magento.rating: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица magento.rating_entity
...
-- Дамп данных таблицы magento.rating_entity: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица magento.rating_option
...
-- Дамп данных таблицы magento.rating_option: ~15 rows (приблизительно)
...
-- Дамп структуры для таблица magento.rating_option_vote
...
-- Дамп данных таблицы magento.rating_option_vote: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `rating_option_vote` DISABLE KEYS */;
/*!40000 ALTER TABLE `rating_option_vote` ENABLE KEYS */;


-- Дамп структуры для таблица magento.rating_option_vote_aggregated
...
-- Дамп данных таблицы magento.rating_option_vote_aggregated: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `rating_option_vote_aggregated` DISABLE KEYS */;
/*!40000 ALTER TABLE `rating_option_vote_aggregated` ENABLE KEYS */;


-- Дамп структуры для таблица magento.rating_store
...
-- Дамп данных таблицы magento.rating_store: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `rating_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `rating_store` ENABLE KEYS */;


-- Дамп структуры для таблица magento.rating_title
...
-- Дамп данных таблицы magento.rating_title: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `rating_title` DISABLE KEYS */;
/*!40000 ALTER TABLE `rating_title` ENABLE KEYS */;


-- Дамп структуры для таблица magento.report_compared_product_index
...
-- Дамп данных таблицы magento.report_compared_product_index: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `report_compared_product_index` DISABLE KEYS */;
/*!40000 ALTER TABLE `report_compared_product_index` ENABLE KEYS */;


-- Дамп структуры для таблица magento.report_event
...
-- Дамп данных таблицы magento.report_event: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `report_event` DISABLE KEYS */;
/*!40000 ALTER TABLE `report_event` ENABLE KEYS */;


-- Дамп структуры для таблица magento.report_event_types
...
-- Дамп данных таблицы magento.report_event_types: ~6 rows (приблизительно)
...
-- Дамп структуры для таблица magento.report_viewed_product_aggregated_daily
...
-- Дамп данных таблицы magento.report_viewed_product_aggregated_daily: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.report_viewed_product_aggregated_monthly
...
-- Дамп данных таблицы magento.report_viewed_product_aggregated_monthly: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.report_viewed_product_aggregated_yearly
...
-- Дамп данных таблицы magento.report_viewed_product_aggregated_yearly: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.report_viewed_product_index
...
-- Дамп данных таблицы magento.report_viewed_product_index: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `report_viewed_product_index` DISABLE KEYS */;
/*!40000 ALTER TABLE `report_viewed_product_index` ENABLE KEYS */;


-- Дамп структуры для таблица magento.review
...
-- Дамп данных таблицы magento.review: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `review` DISABLE KEYS */;
/*!40000 ALTER TABLE `review` ENABLE KEYS */;


-- Дамп структуры для таблица magento.review_detail
...
-- Дамп данных таблицы magento.review_detail: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `review_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `review_detail` ENABLE KEYS */;


-- Дамп структуры для таблица magento.review_entity
...
-- Дамп данных таблицы magento.review_entity: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица magento.review_entity_summary
...
-- Дамп данных таблицы magento.review_entity_summary: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `review_entity_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `review_entity_summary` ENABLE KEYS */;


-- Дамп структуры для таблица magento.review_status
...
-- Дамп данных таблицы magento.review_status: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица magento.review_store
...
-- Дамп данных таблицы magento.review_store: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `review_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `review_store` ENABLE KEYS */;


-- Дамп структуры для таблица magento.salesrule
...
-- Дамп данных таблицы magento.salesrule: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `salesrule` DISABLE KEYS */;
/*!40000 ALTER TABLE `salesrule` ENABLE KEYS */;


-- Дамп структуры для таблица magento.salesrule_coupon
...
-- Дамп данных таблицы magento.salesrule_coupon: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `salesrule_coupon` DISABLE KEYS */;
/*!40000 ALTER TABLE `salesrule_coupon` ENABLE KEYS */;


-- Дамп структуры для таблица magento.salesrule_coupon_usage
...
-- Дамп данных таблицы magento.salesrule_coupon_usage: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `salesrule_coupon_usage` DISABLE KEYS */;
/*!40000 ALTER TABLE `salesrule_coupon_usage` ENABLE KEYS */;


-- Дамп структуры для таблица magento.salesrule_customer
...
-- Дамп данных таблицы magento.salesrule_customer: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `salesrule_customer` DISABLE KEYS */;
/*!40000 ALTER TABLE `salesrule_customer` ENABLE KEYS */;


-- Дамп структуры для таблица magento.salesrule_customer_group
...
-- Дамп данных таблицы magento.salesrule_customer_group: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `salesrule_customer_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `salesrule_customer_group` ENABLE KEYS */;


-- Дамп структуры для таблица magento.salesrule_label
...
-- Дамп данных таблицы magento.salesrule_label: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `salesrule_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `salesrule_label` ENABLE KEYS */;


-- Дамп структуры для таблица magento.salesrule_product_attribute
...
-- Дамп данных таблицы magento.salesrule_product_attribute: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `salesrule_product_attribute` DISABLE KEYS */;
/*!40000 ALTER TABLE `salesrule_product_attribute` ENABLE KEYS */;


-- Дамп структуры для таблица magento.salesrule_website
...
-- Дамп данных таблицы magento.salesrule_website: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `salesrule_website` DISABLE KEYS */;
/*!40000 ALTER TABLE `salesrule_website` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_bestsellers_aggregated_daily
...
-- Дамп данных таблицы magento.sales_bestsellers_aggregated_daily: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_bestsellers_aggregated_monthly
...
-- Дамп данных таблицы magento.sales_bestsellers_aggregated_monthly: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_bestsellers_aggregated_yearly
...
-- Дамп данных таблицы magento.sales_bestsellers_aggregated_yearly: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_billing_agreement
...
-- Дамп данных таблицы magento.sales_billing_agreement: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_billing_agreement` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_billing_agreement` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_billing_agreement_order
...
-- Дамп данных таблицы magento.sales_billing_agreement_order: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_billing_agreement_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_billing_agreement_order` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_creditmemo
...
-- Дамп данных таблицы magento.sales_flat_creditmemo: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_creditmemo` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_creditmemo` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_creditmemo_comment
...
-- Дамп данных таблицы magento.sales_flat_creditmemo_comment: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_creditmemo_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_creditmemo_comment` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_creditmemo_grid
...
-- Дамп данных таблицы magento.sales_flat_creditmemo_grid: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_creditmemo_grid` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_creditmemo_grid` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_creditmemo_item
...
-- Дамп данных таблицы magento.sales_flat_creditmemo_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_creditmemo_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_creditmemo_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_invoice
...
-- Дамп данных таблицы magento.sales_flat_invoice: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_invoice` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_invoice` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_invoice_comment
...
-- Дамп данных таблицы magento.sales_flat_invoice_comment: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_invoice_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_invoice_comment` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_invoice_grid
...
-- Дамп данных таблицы magento.sales_flat_invoice_grid: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_invoice_grid` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_invoice_grid` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_invoice_item
...
-- Дамп данных таблицы magento.sales_flat_invoice_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_invoice_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_invoice_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_order
...
-- Дамп данных таблицы magento.sales_flat_order: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_order` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_order_address
...
-- Дамп данных таблицы magento.sales_flat_order_address: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_order_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_order_address` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_order_grid
...
-- Дамп данных таблицы magento.sales_flat_order_grid: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_order_grid` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_order_grid` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_order_item
...
-- Дамп данных таблицы magento.sales_flat_order_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_order_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_order_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_order_payment
...
-- Дамп данных таблицы magento.sales_flat_order_payment: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_order_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_order_payment` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_order_status_history
...
-- Дамп данных таблицы magento.sales_flat_order_status_history: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_flat_quote
...
-- Дамп данных таблицы magento.sales_flat_quote: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_quote` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_quote` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_quote_address
...
-- Дамп данных таблицы magento.sales_flat_quote_address: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_quote_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_quote_address` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_quote_address_item
...
-- Дамп данных таблицы magento.sales_flat_quote_address_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_quote_address_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_quote_address_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_quote_item
...
-- Дамп данных таблицы magento.sales_flat_quote_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_quote_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_quote_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_quote_item_option
...
-- Дамп данных таблицы magento.sales_flat_quote_item_option: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_quote_item_option` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_quote_item_option` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_quote_payment
...
-- Дамп данных таблицы magento.sales_flat_quote_payment: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_quote_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_quote_payment` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_quote_shipping_rate
...
-- Дамп данных таблицы magento.sales_flat_quote_shipping_rate: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_flat_shipment
...
-- Дамп данных таблицы magento.sales_flat_shipment: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_shipment` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_shipment` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_shipment_comment
...
-- Дамп данных таблицы magento.sales_flat_shipment_comment: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_shipment_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_shipment_comment` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_shipment_grid
...
-- Дамп данных таблицы magento.sales_flat_shipment_grid: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_shipment_grid` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_shipment_grid` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_shipment_item
...
-- Дамп данных таблицы magento.sales_flat_shipment_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_shipment_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_shipment_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_flat_shipment_track
...
-- Дамп данных таблицы magento.sales_flat_shipment_track: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_flat_shipment_track` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_flat_shipment_track` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_invoiced_aggregated
...
-- Дамп данных таблицы magento.sales_invoiced_aggregated: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_invoiced_aggregated` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_invoiced_aggregated` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_invoiced_aggregated_order
...
-- Дамп данных таблицы magento.sales_invoiced_aggregated_order: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_order_aggregated_created
...
-- Дамп данных таблицы magento.sales_order_aggregated_created: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_order_aggregated_updated
...
-- Дамп данных таблицы magento.sales_order_aggregated_updated: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_order_status
...
-- Дамп данных таблицы magento.sales_order_status: ~12 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_order_status_label
...
-- Дамп данных таблицы magento.sales_order_status_label: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_order_status_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_order_status_label` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_order_status_state
...
-- Дамп данных таблицы magento.sales_order_status_state: ~9 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_order_tax
...
-- Дамп данных таблицы magento.sales_order_tax: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_order_tax` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_order_tax` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_order_tax_item
...
-- Дамп данных таблицы magento.sales_order_tax_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_order_tax_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_order_tax_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_payment_transaction
...
-- Дамп данных таблицы magento.sales_payment_transaction: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_payment_transaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_payment_transaction` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_recurring_profile
...
-- Дамп данных таблицы magento.sales_recurring_profile: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_recurring_profile` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_recurring_profile` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_recurring_profile_order
...
-- Дамп данных таблицы magento.sales_recurring_profile_order: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_recurring_profile_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_recurring_profile_order` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_refunded_aggregated
...
-- Дамп данных таблицы magento.sales_refunded_aggregated: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_refunded_aggregated` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_refunded_aggregated` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_refunded_aggregated_order
...
-- Дамп данных таблицы magento.sales_refunded_aggregated_order: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sales_shipping_aggregated
...
-- Дамп данных таблицы magento.sales_shipping_aggregated: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sales_shipping_aggregated` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_shipping_aggregated` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sales_shipping_aggregated_order
...
-- Дамп данных таблицы magento.sales_shipping_aggregated_order: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.sendfriend_log
...
-- Дамп данных таблицы magento.sendfriend_log: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sendfriend_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `sendfriend_log` ENABLE KEYS */;


-- Дамп структуры для таблица magento.shipping_tablerate
...
-- Дамп данных таблицы magento.shipping_tablerate: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `shipping_tablerate` DISABLE KEYS */;
/*!40000 ALTER TABLE `shipping_tablerate` ENABLE KEYS */;


-- Дамп структуры для таблица magento.sitemap
...
-- Дамп данных таблицы magento.sitemap: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `sitemap` DISABLE KEYS */;
/*!40000 ALTER TABLE `sitemap` ENABLE KEYS */;


-- Дамп структуры для таблица magento.tag
...
-- Дамп данных таблицы magento.tag: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `tag` ENABLE KEYS */;


-- Дамп структуры для таблица magento.tag_properties
...
-- Дамп данных таблицы magento.tag_properties: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `tag_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `tag_properties` ENABLE KEYS */;


-- Дамп структуры для таблица magento.tag_relation
...
-- Дамп данных таблицы magento.tag_relation: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `tag_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `tag_relation` ENABLE KEYS */;


-- Дамп структуры для таблица magento.tag_summary
...
-- Дамп данных таблицы magento.tag_summary: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `tag_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `tag_summary` ENABLE KEYS */;


-- Дамп структуры для таблица magento.tax_calculation
...
-- Дамп данных таблицы magento.tax_calculation: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.tax_calculation_rate
...
-- Дамп данных таблицы magento.tax_calculation_rate: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица magento.tax_calculation_rate_title
...
-- Дамп данных таблицы magento.tax_calculation_rate_title: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `tax_calculation_rate_title` DISABLE KEYS */;
/*!40000 ALTER TABLE `tax_calculation_rate_title` ENABLE KEYS */;


-- Дамп структуры для таблица magento.tax_calculation_rule
...
-- Дамп данных таблицы magento.tax_calculation_rule: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица magento.tax_class
...
-- Дамп данных таблицы magento.tax_class: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица magento.tax_order_aggregated_created
...
-- Дамп данных таблицы magento.tax_order_aggregated_created: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `tax_order_aggregated_created` DISABLE KEYS */;
/*!40000 ALTER TABLE `tax_order_aggregated_created` ENABLE KEYS */;


-- Дамп структуры для таблица magento.tax_order_aggregated_updated
...
-- Дамп данных таблицы magento.tax_order_aggregated_updated: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `tax_order_aggregated_updated` DISABLE KEYS */;
/*!40000 ALTER TABLE `tax_order_aggregated_updated` ENABLE KEYS */;


-- Дамп структуры для таблица magento.weee_discount
...
-- Дамп данных таблицы magento.weee_discount: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `weee_discount` DISABLE KEYS */;
/*!40000 ALTER TABLE `weee_discount` ENABLE KEYS */;


-- Дамп структуры для таблица magento.weee_tax
...
-- Дамп данных таблицы magento.weee_tax: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `weee_tax` DISABLE KEYS */;
/*!40000 ALTER TABLE `weee_tax` ENABLE KEYS */;


-- Дамп структуры для таблица magento.widget
...
-- Дамп данных таблицы magento.widget: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `widget` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget` ENABLE KEYS */;


-- Дамп структуры для таблица magento.widget_instance
...
-- Дамп данных таблицы magento.widget_instance: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `widget_instance` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_instance` ENABLE KEYS */;


-- Дамп структуры для таблица magento.widget_instance_page
...
-- Дамп данных таблицы magento.widget_instance_page: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `widget_instance_page` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_instance_page` ENABLE KEYS */;


-- Дамп структуры для таблица magento.widget_instance_page_layout
...
-- Дамп данных таблицы magento.widget_instance_page_layout: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `widget_instance_page_layout` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_instance_page_layout` ENABLE KEYS */;


-- Дамп структуры для таблица magento.wishlist
...
-- Дамп данных таблицы magento.wishlist: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `wishlist` DISABLE KEYS */;
/*!40000 ALTER TABLE `wishlist` ENABLE KEYS */;


-- Дамп структуры для таблица magento.wishlist_item
...
-- Дамп данных таблицы magento.wishlist_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `wishlist_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `wishlist_item` ENABLE KEYS */;


-- Дамп структуры для таблица magento.wishlist_item_option
...
-- Дамп данных таблицы magento.wishlist_item_option: ~0 rows (приблизительно)
